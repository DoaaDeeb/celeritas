...
TEST_F(SeltzerBergerReaderTest, read_hydrogen)
{
    const double expected_result_y[]
    ...
    const double expected_result_x[]
...

    {
        ...
        EXPECT_VEC_SOFT_EQ(expected_result_x, result.x);
        EXPECT_VEC_SOFT_EQ(expected_result_y, result.y);
